...
public class TofuCreeperEntity extends MonsterEntity implements IChargeableMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new TofuCreeperSwellGoal(this));
    ...
    protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
        ...
        if (entity != this && entity instanceof TofuCreeperEntity) {
            TofuCreeperEntity creeperentity = (TofuCreeperEntity) entity;
    ...
    private void explode() {
        if (!this.world.isRemote) {
            ...
            for (int i = 0; i < 10 * tofuAmount; ++i) {
                ...
                double d1 = (rand.nextFloat() * 2) - 1.0F;
                double d2 = (rand.nextFloat() * 2) - 1.0F;
                double d3 = (double) MathHelper.sqrt(d0 * d0 + d2 * d2);

                tofu.setMotion(d0 * 0.75, d1 + d3 * 0.12D, d2 * 0.75);
