...
public class ChunkGeneratorTofuWorld extends ChunkGenerator {
    public static final Codec<ChunkGeneratorTofuWorld> codecTofuChunk = RecordCodecBuilder.create((instance) ->
            instance.group(
                    BiomeProvider.field_235202_a_.fieldOf("biome_source").forGetter((obj) -> obj.biomeProvider),
                    Codec.LONG.fieldOf("seed").stable().forGetter((obj) -> obj.seeds),
                    DimensionSettings.field_236098_b_.fieldOf("settings").forGetter((obj) -> obj.dimensionSettings))
                    .apply(instance, instance.stable(ChunkGeneratorTofuWorld::new)));
    ...
    public ChunkGeneratorTofuWorld(BiomeProvider p_i231903_1_, long p_i231903_2_, DimensionSettings p_i231903_4_) {
        this(p_i231903_1_, p_i231903_1_, p_i231903_2_, p_i231903_4_);
    }

    private ChunkGeneratorTofuWorld(BiomeProvider p_i231904_1_, BiomeProvider p_i231904_2_, long p_i231904_3_, DimensionSettings p_i231904_5_) {
        super(p_i231904_1_, p_i231904_2_, p_i231904_5_.func_236108_a_(), p_i231904_3_);
        this.seeds = p_i231904_3_;
        this.dimensionSettings = p_i231904_5_;
        ...
        this.defaultFluid = TofuBlocks.SOYMILK.getDefaultState();
    ...
    protected Codec<? extends ChunkGenerator> func_230347_a_() {
        return codecTofuChunk;
    }

    @OnlyIn(Dist.CLIENT)
    public ChunkGenerator func_230349_a_(long p_230349_1_) {
        return new NoiseChunkGenerator(this.biomeProvider.func_230320_a_(p_230349_1_), p_230349_1_, this.dimensionSettings);
    }

    public boolean func_236088_a_(long p_236088_1_, DimensionSettings.Preset p_236088_3_) {
        return this.seeds == p_236088_1_ && this.dimensionSettings.func_236109_a_(p_236088_3_);
    }
                ...
                if (flag) {
                    for (int j1 = 0; j1 < 5; ++j1) {
                        if (j1 <= rand.nextInt(5)) {
                            chunkIn.setBlockState(blockpos$mutable.setPos(blockpos.getX(), l - j1, blockpos.getZ()), TofuBlocks.TOFUBEDROCK.getDefaultState(), false);
                        }
                    }
                }
                ...
                if (flag1) {
                    for (int k1 = 4; k1 >= 0; --k1) {
                        if (k1 <= rand.nextInt(5)) {
                            chunkIn.setBlockState(blockpos$mutable.setPos(blockpos.getX(), k + k1, blockpos.getZ()), TofuBlocks.TOFUBEDROCK.getDefaultState(), false);
                        }
                    }
                }
            }
