...
public class TofuWorldBiomeProvider extends BiomeProvider {
    ...
    public static final Set<Biome> biomes = ImmutableSet.of(TofuBiomes.TOFU_FOREST, TofuBiomes.TOFUZUNDA_SWAMP, TofuBiomes.TOFU_PLAIN, TofuBiomes.ZUNDATOFU_PLAIN, TofuBiomes.ZUNDATOFU_FUNGIFOREST, TofuBiomes.TOFU_BUILDING, TofuBiomes.TOFU_MOUNTAIN, TofuBiomes.TOFU_RIVER);
