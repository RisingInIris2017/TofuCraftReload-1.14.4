...
public class StructureVoidProcessor extends StructureProcessor {
    ...
    static final IStructureProcessorType TYPE = Registry.register(Registry.STRUCTURE_PROCESSOR, TofuCraftCore.MODID + ":structure_void", StructureVoidProcessor::new);
