...
public class SoulFukumameRender<T extends SoulFukumameEntity> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURES = new ResourceLocation(TofuCraftCore.MODID, "textures/entity/soul_fukumame.png");

    public SoulFukumameRender(EntityRendererManager renderManagerIn) {
