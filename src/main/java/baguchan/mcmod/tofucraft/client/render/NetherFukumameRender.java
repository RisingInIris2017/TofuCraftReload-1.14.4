...
public class NetherFukumameRender<T extends NetherFukumameEntity> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURES = new ResourceLocation(TofuCraftCore.MODID, "textures/entity/nether_fukumame.png");

    public NetherFukumameRender(EntityRendererManager renderManagerIn) {
