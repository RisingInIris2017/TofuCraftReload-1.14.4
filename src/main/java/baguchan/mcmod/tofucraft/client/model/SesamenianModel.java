...
public class SesamenianModel extends BipedModel<SesamenianEntity> {

    public SesamenianModel() {
        this(0.0F, false);
    }

    protected SesamenianModel(float par1, float par2, int par3, int par4) {
        super(par1, par2, par3, par4);
    }

    public SesamenianModel(float par1, boolean par2) {
...
//        this.bipedEars.addBox(-3.0F, 1.0F, -1.0F, 6, 6, 1, par1);
    ...
    @Override
    public void render(SesamenianEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
    ...
    @Override
    public void setRotationAngles(SesamenianEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
