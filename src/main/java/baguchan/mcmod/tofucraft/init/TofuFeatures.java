...
/*
    public static final Feature<NoFeatureConfig> TOFUFLOWER = new FlowersFeature(NoFeatureConfig.field_236558_a_) {
        @Override
...
*/
    ...
    /*public static final Feature<NoFeatureConfig> ZUNDAMUSHROOM_SMALL = new TofuTemplateFeature(NoFeatureConfig.field_236558_a_, 7, 7, new ResourceLocation[]{
    ...
    public static final Feature<NoFeatureConfig> ZUNDAMUSHROOM_BIG = new TofuTemplateFeature(NoFeatureConfig.field_236558_a_, 9, 9, new ResourceLocation[]{
    ...
    public static final Feature<NoFeatureConfig> TOFU_BUILDING = new TofuTemplateFeature(NoFeatureConfig.field_236558_a_, 4, 4, new ResourceLocation[]{
    ...
    //public static final Feature<OreConfig> TOFUORE = new TofuOreFeature(TofuOreConfig::deserialize);
