...
public class TofuItems {
    ...
    public static final Item NETHERMANJU = new Item(new Item.Properties().food(TofuFoods.NETHERMANJU).group(TofuItemGroup.TOFUCRAFT));
    ...
    public static void registerItems(RegistryEvent.Register<Item> registry) {
        ...
        register(registry, NETHERMANJU, "nethermanju");
        ...
        ComposterBlock.CHANCES.put(SEEDS_SOYBEAN_SOUL, 0.3F);
        ComposterBlock.CHANCES.put(SEEDS_RICE, 0.25F);
        ComposterBlock.CHANCES.put(RICE, 0.35F);
        ComposterBlock.CHANCES.put(LEEK, 0.25F);

        ItemModelsProperties.func_239418_a_(TOFUISHI_SHIELD, new ResourceLocation("blocking"), (p_239419_0_, p_239419_1_, p_239419_2_) -> {
        ...
        ItemModelsProperties.func_239418_a_(ZUNDABOW, new ResourceLocation("pulling"), (p_239428_0_, p_239428_1_, p_239428_2_) -> {
