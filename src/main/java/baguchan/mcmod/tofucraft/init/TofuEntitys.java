...
public class TofuEntitys {
    ...
    public static final EntityType<TofunianEntity> TOFUNIAN = EntityType.Builder.create(TofunianEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true).size(0.6F, 1.2F).build(prefix("tofunian"));
    ...
    public static final EntityType<GrillderEntity> GRILLDER = EntityType.Builder.create(GrillderEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true).size(0.6F, 0.65F).build(prefix("grillder"));
    ...
    public static final EntityType<TofuEagleEntity> TOFUEAGLE = EntityType.Builder.create(TofuEagleEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true).size(0.6F, 0.65F).build(prefix("tofueagle"));
    ...
    public static final EntityType<SesamenianEntity> SESAMENIAN = EntityType.Builder.create(SesamenianEntity::new, TOFU_MONSTER).setShouldReceiveVelocityUpdates(true).size(0.6F, 1.2F).build(prefix("sesamenian"));
