...
public class TofuTileEntitys {
    ...
    public static final TileEntityType<TFStorageTileEntity> TFSTORAGE = TileEntityType.Builder.create(TFStorageTileEntity::new, TofuBlocks.TFSTORAGE).build(null);


    @SubscribeEvent
    public static void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
        event.getRegistry().register(TOFUCHEST.setRegistryName("tofuchest"));
        event.getRegistry().register(TFSTORAGE.setRegistryName("tfstorage"));
    }
}
