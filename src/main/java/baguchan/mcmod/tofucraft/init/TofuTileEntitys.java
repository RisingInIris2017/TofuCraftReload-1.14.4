...
public class TofuTileEntitys {
    public static final TileEntityType<? extends ChestTileEntity> TOFUCHEST = TileEntityType.Builder.create(TofuChestTileEntity::new, TofuBlocks.TOFUCHEST).build(null);
