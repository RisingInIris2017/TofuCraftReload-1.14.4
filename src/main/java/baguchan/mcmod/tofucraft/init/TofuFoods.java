...
public class TofuFoods {
    ...
    public static final Food ENCHANTED_ZUNDAMOCHI = new Food.Builder().hunger(4).saturation(0.36f).fastToEat().setAlwaysEdible().effect(new EffectInstance(Effects.REGENERATION, 100), 1).build();
}
