    ...
    public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
        ...
        if (stateIn.get(WATERLOGGED)) {
            ...
            if (stat == Stat.EMPTY || stat == Stat.BITTERN) {
                ...
                ItemEntity itemEntity = new ItemEntity(worldIn.getWorld(), (double) currentPos.getX() + d0, (double) currentPos.getY() + d1, (double) currentPos.getZ() + d2, salt);
        ...
        return facing.getAxis().isHorizontal() ? stateIn.with(NORTH, this.canConnectTo(worldIn.getWorld(), currentPos.north()))
                .with(EAST, this.canConnectTo(worldIn.getWorld(), currentPos.east()))
                .with(SOUTH, this.canConnectTo(worldIn.getWorld(), currentPos.south()))
                .with(WEST, this.canConnectTo(worldIn.getWorld(), currentPos.west())) : super.updatePostPlacement(stateIn, facing, facingState, worldIn, currentPos, facingPos);
    }
