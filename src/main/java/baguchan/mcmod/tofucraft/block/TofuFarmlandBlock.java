...
public class TofuFarmlandBlock extends Block {
    ...
    public TofuFarmlandBlock(Block.Properties builder) {
        super(builder);
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        return !this.getDefaultState().isValidPosition(context.getWorld(), context.getPos()) ? TofuBlocks.TOFUTERRAIN.getDefaultState() : super.getStateForPlacement(context);
    }
    ...
    public void onFallenUpon(World worldIn, BlockPos pos, Entity entityIn, float fallDistance) {
        if (!worldIn.isRemote && net.minecraftforge.common.ForgeHooks.onFarmlandTrample(worldIn, pos, TofuBlocks.TOFUTERRAIN.getDefaultState(), fallDistance, entityIn)) { // Forge: Move logic to Entity#canTrample
    ...
    public static void turnToDirt(BlockState state, World worldIn, BlockPos pos) {
        worldIn.setBlockState(pos, nudgeEntitiesWithNewState(state, TofuBlocks.TOFUTERRAIN.getDefaultState(), worldIn, pos));
    }
